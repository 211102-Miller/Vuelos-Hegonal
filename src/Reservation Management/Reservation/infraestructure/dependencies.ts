import { PostgresReservationRepository } from "./Repository/mysqlReservationRepository";
...
export const mysqlReservationRepository = new PostgresReservationRepository();
