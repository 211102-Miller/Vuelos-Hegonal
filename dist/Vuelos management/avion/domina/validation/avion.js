...
class ValidatorCreate {
    constructor(uuid, name, model, capacity, airline) {
        this.uuid = uuid;
        this.name = name;
        this.model = model;
...
__decorate([
    ...
    (0, class_validator_1.Length)(1, 100),
    __metadata("design:type", String)
], ValidatorCreate.prototype, "model", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsNumber)(),
    __metadata("design:type", Number)
], ValidatorCreate.prototype, "capacity", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], ValidatorCreate.prototype, "airline", void 0);
class ValidatorId {
    constructor(uuid) {
        this.uuid = uuid;
    }
...
__decorate([
    ...
    (0, class_validator_1.IsNumber)(),
    __metadata("design:type", Number)
], ValidatorUpdate.prototype, "capacity", void 0);
