...
exports.DeleteAsientoUseCase = void 0;
const class_validator_1 = require("class-validator");
const asiento_1 = require("../domina/validation/asiento");
class DeleteAsientoUseCase {
    ...
    run(uuid) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const taske = yield this.asientoRepository.delete(uuid);
                return taske;
            }
            catch (error) {
                return null;
...
exports.DeleteAsientoUseCase = DeleteAsientoUseCase;
